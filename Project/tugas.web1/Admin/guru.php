...
<div class="card">
    <div class="card-header">
        <div class="page-actions">
            <a href="guru_tambah.php" class="btn">
    ...
    <div class="card-body">
        ...
        <?php if (isset($_GET['pesan'])): ?>
            <div class="alert alert-success">
                ...
                if ($_GET['pesan'] == 'hapus') echo "🗑️ Data guru berhasil dihapus!";
                ?>
            </div>
        <?php endif; ?>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td><?= $row['username'] ?></td>
                            <td>
                                <a href="guru_edit.php?id=<?= $row['id_guru'] ?>" class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <!-- HAPUS + CATAT AKTIVITAS -->
